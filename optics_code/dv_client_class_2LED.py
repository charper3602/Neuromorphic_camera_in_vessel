...
class tracker(): #object to do the calculations
  def __init__(self, vel,ind,success1,success2,failure1,failure2,text_code,count_array,max_freq,coordpresent,coordpast,ind2,coordx_array,coordy_array,calculated_text,successrate1_text,successrate2_text,running1_text,running2_text,freq_text,textpresent ):
  ...
  def rate(self): #handle changes to error rate and calcuate the codes give the freqencies
            if((np.abs(self.max_freq)>=2.05)and(np.abs(self.max_freq)<=2.20)): #find if the LED is outputing a 1
            ...
            if((np.abs(self.max_freq)>=4.4)and(np.abs(self.max_freq)<=4.8)):#find if the LED is outputing a 0
...
def find_first_boolean_occurrence(arr, target_value): #finds the first occurance of a unfilled LED 
    ...
    return -1
def rangefinder(coordxmin,coordxmax,coordymin,coordymax,LED_array=tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)): # Find if the potenial LED is inside the range of another LED and prevent duplications
...
def task(h,coord_detect,frame,input,LED_array=tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)): # Main task function for running plotting,displaying, and inputs
        ...
        # print(f"{h}: X:{coord_detect[0]} vs {LED_array[h].coordpresent[0]}Y:{coord_detect[1]} vs {LED_array[h].coordpresent[1]}")
         ...
         if((LED_array[h].ind==True)and(coord_detect[1]>=LED_array[h].coordpresent[1]-15)and(coord_detect[0]>=LED_array[h].coordpresent[0]-15)and(coord_detect[1]<=LED_array[h].coordpresent[1]+15)and(coord_detect[0]<=LED_array[h].coordpresent[0]*+15)):#check if the potenial LED is in the movement region of a currently existing LED
              ...
              if(input=="Y"or input=="y"): #choose plotting
                ...
                LED_array[h].plot(30,33) #plot and display the pixel count and preform transform to get frq
              ...
              if(input=="N"or input=="n"): #choose no plotting
                (LED_array[h]).pixel_counter(frame)#output the pixel count
                (LED_array[h]).rate()#output the text
                (LED_array[h]).frq(30,33) #display the pixel count and preform transform to get frq
              ...
              if((LED_array[h].success1/(LED_array[h].failure1+LED_array[h].success1)>.5)and((LED_array[h].success2/(LED_array[h].failure2+LED_array[h].success2)<.10))):#check if its a valid code
                    ...
                    cv.putText(frame,f"ID:1 X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .25,(0,0,0),1,cv.LINE_AA)
                    cv.putText(frame,f"Velocity 1: X:{LED_array[h].vel[0]}, Y:{LED_array[h].vel[1]}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+50), font, .25,(0,0,0),1,cv.LINE_AA)
              if((LED_array[h].success2/(LED_array[h].failure2+LED_array[h].success2)>.5)and((LED_array[h].success1/(LED_array[h].failure1+LED_array[h].success1)<.10))):#check if its a valid code
                    LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(55/50),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(55/50))  
                    cv.putText(frame,f"ID:2 X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .25,(0,0,0),1,cv.LINE_AA)
                    cv.putText(frame,f"Velocity:2 X:{LED_array[h].vel[0]}, Y:{LED_array[h].vel[1]}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+50), font, .25,(0,0,0),1,cv.LINE_AA)
              LED_array[h].coordpast=LED_array[h].coordpresent 
         if(LED_array[h].ind==False): #case for if the LED has not been filled with a coordinate yet 
              # print(f"{h}vs {coord_detect[1]} vs {LED_array[h].coordpresent[1]*1.1}")
              # print(f"{h}vs {LED_array[h].ind}")
               in_range=rangefinder(coord_detect[0]-60,coord_detect[0]+60,coord_detect[1]-60,coord_detect[1]+60,LED_array) #check the range to see if its a valid new coordinate
               if((in_range==False)):
...
LED1= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED2= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED3= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED4= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None) #initalize all 10 LEDs
LED5= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED6= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED7= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED8= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED9= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED10= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
...
def show_preview(events: dv.EventStore): #PCA function 
   ...
   # cv.imshow("Preview", frame)
    ...
    frame, 60, 60, 60, 60, cv.BORDER_CONSTANT, value=[255, 255, 255]) 

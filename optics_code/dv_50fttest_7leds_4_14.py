...
class tracker(): #object to do the calculations
  def __init__(self,vel,ind,success1,success2,success3,success4,success5,success6,success7,success8,
  ...
  def rate(self): #handle changes to error rate and calcuate the codes give the freqencies
            #pattern1
            if((np.abs(self.max_freq)>=1.0)and(np.abs(self.max_freq)<=1.9)): #find if the LED is outputing a 1
            ...
            #pattern2
            if((np.abs(self.max_freq)>=2.0)and(np.abs(self.max_freq)<=2.6)):#find if the LED is outputing a 0
            ...
            #pattern4
            if((np.abs(self.max_freq)>=4.0)and(np.abs(self.max_freq)<=4.6)):#find if the LED is outputing a 0
                self.text_code=self.text_code+"0"
            ...
            #pattern5
            if((np.abs(self.max_freq)>=5.0)and(np.abs(self.max_freq)<=5.8)):#find if the LED is outputing a 0
                self.text_code=self.text_code+"0"
            ...
            #pattern6
            if((np.abs(self.max_freq)>=6.0)and(np.abs(self.max_freq)<=6.6)):#find if the LED is outputing a 0
                self.text_code=self.text_code+"0"
            ...
            #pattern7
            if((np.abs(self.max_freq)>=7.0)and(np.abs(self.max_freq)<=7.8)):#find if the LED is outputing a 0
                self.text_code=self.text_code+"0"
            ...
            #pattern8
            if((np.abs(self.max_freq)>=8)and(np.abs(self.max_freq)<=8.7)):#find if the LED is outputing a 0
                self.text_code=self.text_code+"0"
...
def find_first_boolean_occurrence(arr, target_value): #finds the first occurance of a unfilled LED 
    ...
    return -1
def rangefinder(coordxmin,coordxmax,coordymin,coordymax,LED_array=tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)): # Find if the potenial LED is inside the range of another LED and prevent duplications
...
def task(h,coord_detect,frame,input,LED_array=tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)): # Main task function for running plotting,displaying, and inputs
         ...
         if((LED_array[h].ind==True)and(coord_detect[1]>=LED_array[h].coordpresent[1]-15)and(coord_detect[0]>=LED_array[h].coordpresent[0]-15)and(coord_detect[1]<=LED_array[h].coordpresent[1]+15)and(coord_detect[0]<=LED_array[h].coordpresent[0]+15)):#check if the potenial LED is in the movement region of a currently existing LED
               ...
               if((LED_array[h].successCount >= 5)):
                ...
                if((LED_array[h].success1/(LED_array[h].failure1+LED_array[h].success1)>.5)and((LED_array[h].success2/(LED_array[h].failure2+LED_array[h].success2)<.10))):#check if its a valid code
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{1} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{1} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success2/(LED_array[h].failure2+LED_array[h].success2)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{2} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{2} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success3/(LED_array[h].failure3+LED_array[h].success3)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{3} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{3} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success4/(LED_array[h].failure4+LED_array[h].success4)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{4} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{4} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success5/(LED_array[h].failure5+LED_array[h].success5)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{5} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{5} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success6/(LED_array[h].failure6+LED_array[h].success6)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{6} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{6} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success7/(LED_array[h].failure7+LED_array[h].success7)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{7} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{7} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
                
                elif((LED_array[h].success8/(LED_array[h].failure8+LED_array[h].success8)>.5)):
                      #print("working")
                      LED_array[h].vel=((LED_array[h].coordpast[1]-LED_array[h].coordpresent[1])*(0.00475),(LED_array[h].coordpast[0]-LED_array[h].coordpresent[0])*(0.00475))  
                      cv.putText(frame,f"ID:{8} X:{LED_array[h].coordpresent[1]}, Y:{LED_array[h].coordpresent[0]}",(LED_array[h].coordpresent[0]+20,LED_array[h].coordpresent[1]), font, .5,(0,0,0),1,cv.LINE_AA)
                      #if((np.abs(LED_array[h].vel[0]*33) >= 0.1)and(np.abs(LED_array[h].vel[1]*33) >= 0.1)):
                      cv.putText(frame,f"Velocity:{8} X:{round(((LED_array[h].vel[0]/0.033)*2.237),3)}, Y:{round(((LED_array[h].vel[1]/0.033)*2.237),3)}",(LED_array[h].coordpresent[0]+10,LED_array[h].coordpresent[1]+20), font, .5,(0,0,0),1,cv.LINE_AA)
...
LED1= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED2= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED3= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED4= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None) #initalize all 10 LEDs
LED5= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED6= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED7= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED8= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED9= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
LED10= tracker(None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None,None)
